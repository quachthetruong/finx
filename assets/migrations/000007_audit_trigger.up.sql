...
-- create audit trigger for tables
select audit.audit_table('score_group');
select audit.audit_table('score_group_interest');
select audit.audit_table('loan_package_request');
select audit.audit_table('loan_package_offer_interest');